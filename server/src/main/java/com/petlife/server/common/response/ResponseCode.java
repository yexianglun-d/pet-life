...
public enum ResponseCode {
    ...
    AUTH_SMS_CODE_EXPIRED("AUTH_SMS_CODE_EXPIRED", "sms verification code is expired"),
    AUTH_SMS_CODE_USED("AUTH_SMS_CODE_USED", "sms verification code is used"),
    AUTH_SMS_CODE_ATTEMPT_LIMITED("AUTH_SMS_CODE_ATTEMPT_LIMITED", "sms verification code attempts exceeded"),
    AUTH_SMS_SEND_RATE_LIMITED("AUTH_SMS_SEND_RATE_LIMITED", "sms verification send is rate limited"),
    AUTH_SMS_SEND_FAILED("AUTH_SMS_SEND_FAILED", "sms verification send failed"),
    ...
    MODERATION_TASK_NOT_FOUND("MODERATION_TASK_NOT_FOUND", "moderation task does not exist"),
